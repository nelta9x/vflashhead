  ...
  describe('spawnFromArchetype', () => {
    it('아키타입 기반으로 엔티티를 스폰해야 함', () => {
      ...
      const p1 = world.spawnFromArchetype(playerArch, {
        ...
        playerInput: { targetX: 10, targetY: 20, isKeyboardInput: false, smoothingConfig: { halfLifeMs: 22.6, keyboardHalfLifeMs: 8, snapThreshold: 175, convergenceThreshold: 0.5, deadZone: 2.5 } },
